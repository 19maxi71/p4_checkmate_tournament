...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.12/site-packages/pygments/styles/native.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.12.site-packages.pygments.styles.native.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.12.site-packages.pygments.styles.native.source.html#l24">
                  <tt><i>24</i>     </tt>
               </a>
            </li>
            </ul>

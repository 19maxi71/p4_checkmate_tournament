...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.12/site-packages/pygments/styles/stata_dark.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.12.site-packages.pygments.styles.stata_dark.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.12.site-packages.pygments.styles.stata_dark.source.html#l23">
                  <tt><i>23</i>     </tt>
               </a>
            </li>
            </ul>

...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.12/site-packages/pygments/styles/stata_light.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.12.site-packages.pygments.styles.stata_light.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.12.site-packages.pygments.styles.stata_light.source.html#l27">
                  <tt><i>27</i>     </tt>
               </a>
            </li>
            </ul>
